...
enum TextLiteral {
  ...
  enum MyPage {
    ...
    static let termsOfUseText: String = """
      ...
      ***제 6조(저작권)***
      이용자가 "EAT-SSU" 서비스 내에서 작성한 리뷰에 관한 저작권은 해당 리
      뷰를 작성한 이용자에게 귀속됩니다.
      ...
      ***제 9조(기타)***
      본 약관은 2023년 10월 29일에 최신화 되었습니다.
