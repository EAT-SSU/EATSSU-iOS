...
enum RestaurantLocation {
  ...
  var title: String {
    switch self {
    case .dormitory:
      return TextLiteral.Restaurant.dormitoryRestaurant
    case .dodam:
      return TextLiteral.Restaurant.dodamRestaurant
    case .studentRestaurant:
      return TextLiteral.Restaurant.studentRestaurant
    case .foodCourt:
      return TextLiteral.Restaurant.foodCourt
    case .snackCorner:
      return TextLiteral.Restaurant.snackCorner
    case .soongsil:
      return "숭실대학교"
    }
  }
...
func setMapView(mapView: MKMapView, for location: RestaurantLocation) {
  let region = MKCoordinateRegion(
    center: location.coordinate, span: MKCoordinateSpan(latitudeDelta: 0.002, longitudeDelta: 0.002)
  )
