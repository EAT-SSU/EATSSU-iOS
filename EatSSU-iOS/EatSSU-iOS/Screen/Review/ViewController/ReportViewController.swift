...
final class ReportViewController: BaseViewController {
  ...
  override func configureUI() {
    ...
    for item in [
      report1Button, report2Button, report3Button, report4Button, report5Button, report6Button,
    ] {
      item.setImage(ImageLiteral.Icon.uncheckedIcon, for: .normal)
      item.setImage(ImageLiteral.Icon.checkedIcon, for: .selected)
    }

    for item in [
      report1Label, report2Label, report3Label, report4Label, report5Label, report6Label,
    ] {
  ...
  override func customNavigationBar() {
    ...
    navBarApperance.titleTextAttributes = [
      .foregroundColor: UIColor.primary, .font: UIFont.bold(size: 18),
    ]
  ...
  @objc private func checkButtonIsTapped(_ sender: UIButton) {
  ...
  public func bindData(reviewID: Int) {
      ...
      UIView.animate(
        ...
        animations: {
          self.view.transform = CGAffineTransform(
            translationX: 0, y: -(keyboardRectangle.height - buttonHeight))
        })
    }
  }
