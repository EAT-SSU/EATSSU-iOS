...
final class MigratedRequest: BaseUIView {
  ...
  private lazy var emailStackView = UIStackView(arrangedSubviews: [
    emailLabel,
    emailTextField,
  ])
  ...
  override func configureUI() {
    ...
    requestLabel.do {
      $0.text = TextLiteral.MyPage.request
      $0.font = .bold(size: 16.adjusted)
      $0.textColor = .black
    }

    emailLabel.do {
      $0.text = TextLiteral.MyPage.email
      $0.font = .medium(size: 16.adjusted)
      $0.textColor = .black
    }

    emailTextField.do {
      $0.placeholder = TextLiteral.MyPage.inputEmail
    ...
    requestContentLabel.do {
      $0.text = TextLiteral.MyPage.requestContent
      $0.font = .medium(size: 16.adjusted)
      $0.textColor = .black
    }
    ...
    maximumTextCountLabel.do {
      $0.text = TextLiteral.MyPage.requestMaximumText
